...
def PushErrorHandler(*args):
    """
    PushErrorHandler(char const * pszCallbackName=None) -> CPLErr
    PushErrorHandler(CPLErrorHandler arg1)
    """
...
def CPLBinaryToHex(*args):
    """CPLBinaryToHex(int nBytes, GByte const * pabyData) -> char *"""
...
def Unlink(*args):
    """Unlink(char const * pszFilename) -> int"""
...
def VSIFSeekL(*args):
    """VSIFSeekL(VSILFILE * arg1, long arg2, int arg3) -> int"""
    return _gdal.VSIFSeekL(*args)

def VSIFTellL(*args):
    """VSIFTellL(VSILFILE * arg1) -> long"""
    return _gdal.VSIFTellL(*args)

def VSIFWriteL(*args):
    """VSIFWriteL(char const * arg1, int arg2, int arg3, VSILFILE * arg4) -> int"""
